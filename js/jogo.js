...
let x = document.querySelector('.x'); //querySelector: buscar dentro de um local um unico elemento
let o = document.querySelector('.o');
let boxes = document.querySelectorAll('.box'); //buscar varios elementos dentro de uma div, por exemplo
